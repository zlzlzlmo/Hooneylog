...
- 3인칭 대명사("그/그녀/그것/그들") 한 단락 3회+ 영어 대명사 직역 → 50%+ 생략(영형)하거나 호칭·명사구로.
...
- 메타 진입어("이는/이 점에서/이 관점에서/이 말은") 3회+ → 본문에 녹이거나 삭제.
- 의인화 추상 주어("기술이 묻는다/시대가 부른다") → 사람·기관 주어로.
- 결말 공식("~할 때다/~해야 한다/지금이야말로") → 평서로 닫거나 삭제.
...
## 자가검증(수정 후)
고유명사·수치·인용 보존 / 변경률 30% 이하 / 장르 유지 / 원문에 없던 비유·수사 임의 추가 금지 / S1 잔존 0(특히 이중 피동·가지다 직역·3인칭 대명사 남용).`;
