        ...
        components={{
          ...
          div({ className, children, ...props }: any) {
            ...
            if (className === 'notion-callout-icon') {
              return <div className="text-[20px] leading-none select-none" {...props}>{children as React.ReactNode}</div>;
            }
            if (className === 'notion-callout-content') {
              return <div className="text-[16px] leading-[1.5] text-notion-text flex-1" {...props}>{children as React.ReactNode}</div>;
            }
            return <div className={className as string} {...props}>{children as React.ReactNode}</div>;
          },
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          li({ children, checked, ...props }: any) {
            ...
            return <li className="text-[16px] leading-[1.6] text-notion-text" {...props}>{children as React.ReactNode}</li>;
          },
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          ...
          ul({ children, ...props }: any) {
            return <ul className="pl-[24px] list-disc mt-1 space-y-1 mb-4" {...props}>{children as React.ReactNode}</ul>;
          },
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          ol({ children, ...props }: any) {
            return <ol className="pl-[24px] list-decimal mt-1 space-y-1 mb-4" {...props}>{children as React.ReactNode}</ol>;
          },
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
