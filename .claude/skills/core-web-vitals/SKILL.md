...
For most sites, the LCP a user actually experiences is dominated by _the next page they navigate to_, not the one they landed on. Telling the browser to prerender likely-next pages on hover collapses that LCP to ~0ms.
